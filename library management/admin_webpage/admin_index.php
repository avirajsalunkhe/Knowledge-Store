...
if(z==1)
{
  ...
  z=1;
      ...
      <div class="nav" id="menulist" style="overflow:'hidden'">
        ...
        <li><a class="o"href="notice_board.php">Notice</a></li>
        <li><a class="a"href="book_table.php">All Books Data</a></li>
        <li><a class="b"href="student_table.php">All Student Data</a></li>
        <li><a class="c"href="faculty_table.php">All Faculty<b>/</b>Admin Data</a></li>
        <li><a class="d"href="book_registration.php">Book Registration</a></li>
        <li><a class="e"href="registration.php">Registration</a></li>
        <li><a class="f"href="admin_logout.php">Logout</a></li>
