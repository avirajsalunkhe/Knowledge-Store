...
{
    $id = $_GET['eid'];
    $querys = "SELECT * FROM admin_data WHERE eid= '$id' ";
    $resultg = mysqli_query($conn,$querys);
    while($row = mysqli_fetch_assoc($resultg))
    {
        $queryg = "SELECT * from all_admin_images where eid = '$id'";
     ...
     while($rowa = mysqli_fetch_array($results))
     {
        if(isset($_POST['btn1'])){
            ...
            $querie ="UPDATE  admin_data SET fname='$fname',lname='$lname',eid='$eid',dep='$dep',enrno='$enrno',psd1='$psd1' WHERE eid = '$id'";
            $queryd ="UPDATE  all_admin_images set uimg='$uimg' where eid='$id'";
       ...
       <form action="" method="post" enctype="multipart/form-data">
          <h3>Update Faculty Data</h3>
            <div class="content">
				...
				<div class="input-box">
                              <label for="enrno">Employee ID :</label>
                ...
                <div class="input-box">
					...
					<a href="faculty_table.php"><button type="button" name="btn2" >Back</button></a>
				</div>
                <!-- <div class="input-box">
                </div> -->
