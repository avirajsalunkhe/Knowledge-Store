...
if(isset($_GET['eid']))
{
    ...
    while($row = mysqli_fetch_assoc($resultg))
    {
     ...
     while($rowa = mysqli_fetch_array($results))
     {
        if(isset($_POST['btn1'])){
            ...
            $querie ="UPDATE  student_data SET psd1='$psd1' WHERE eid = '$id'";
    ...
    if($query_run)
    {
        include "update_profile_mail.php";
          ...
          <h3>Update My Data</h3>
            <div class="content">
                        <div class="input-box">
					          ...
					          <input type="text" value="<?php echo $row['fname'];?>" name= "fname" disabled required>
				        </div>
				<div class="input-box">
                              <label for="lname">Last Name :</label><br>
					          <input type="text" value="<?php echo $row['lname'];?>" name= "lname" disabled required>&nbsp &nbsp &nbsp
				</div>
				
				<div class="input-box">
                              <label for="eid">E-mail :</label>
					<input type="email" value="<?php echo $row['eid'];?>" name= "eid" disabled required>
				</div>
				<div class="input-box">
                              <label for="dep">Department</label>
                            <select name="dep" disabled required>
				...
				<div class="input-box">
					...
					<input type="text" value="<?php echo $row['enrno'];?>" name= "enrno" disabled required>
				</div>
                <div class="input-box">
                ...
                <div class="input-box">
					...
					<a href="student_profile.php"><button type="button" name="btn2" >Back</button></a>
				</div>
                <!-- <div class="input-box">
                </div> -->
...
<p> All Rights Reserved.<br>
  <a href="mailto:avirajsalunkhe1@gmail.com"><i class="material-icons">&#xe0be;</i></a>
    <a href="https://www.instagram.com/its_avi_45_/"><i style="font-size:24px" class="fa">&#xf16d;</i></a>
    </p>
    </center>
</footer>
    </body>
